...
// const age=28;
// age>=22 ? console.log( " You are eligible for sky diving! "):
// console.log(" You are eligible only for jump skating! 😂");

// const Confirmation = age >= 22 ? "Eligible for Sky-Diving" : "Not Eligible for Jump skating!"
...
// console.log(`The bill wa ${bill}, the tip was ${tip}, and the total value ${bill+tip}.Sir!`)

// const x = 301;
// if (x>=50 && x<=300){
//     console.log(`Tip = ${x * 0.15} \nBill = ${x+x*0.15} `);
// } else {
//     console.log (`tip = ${x*0.2} \nBill = ${x+x*0.2}`);
// }
