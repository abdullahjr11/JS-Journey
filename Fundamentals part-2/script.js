...
const tiips=[calcTip(bills[0]),calcTip(bills[1]),calcTip(bills[2])];

const ttotals = (tiips[0],tiips[1],tiips[2]);
console.log(`Total value is ${ttotals} which you have to pay. Danke!`);
